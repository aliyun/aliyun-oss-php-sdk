...
abstract class Result
{
    ...
    {
        if ($response === null) {
            throw new ObsException("raw response is null");
        }
    ...
    public function getRequestId()
    {
        if (isset($this->rawResponse) &&
            ...
            isset($this->rawResponse->header['x-obs-request-id'])
        ) {
            return $this->rawResponse->header['x-obs-request-id'];
        } else {
            return '';
        }
    }
    ...
    public function parseResponse()
    {
        ...
        if ($this->isOk) {
            ...
            print_r($details);
            exit;
            throw new ObsException($details);
        }
    }
