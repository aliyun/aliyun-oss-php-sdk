 ...
 * Class OssException
 *
 * This is the class that OBSClient is expected to thrown, which the caller needs to handle properly.
 * It has the OBS specific errors which is useful for troubleshooting.
 *
 * @package OBS\Core
 */
class ObsException extends \Exception
{
